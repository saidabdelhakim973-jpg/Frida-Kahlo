  ...
  return (
    <div id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-zen-ivory">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-24 lg:gap-40 items-center group">
        <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 lg:space-y-12 lg:pr-16 transition-transform duration-1000 lg:group-hover:-translate-x-32 pb-20 lg:pb-0">
          <motion.div 
          ...
          >
            <div className="flex items-center justify-center lg:justify-start space-x-6">
             ...
             <motion.h1 
              ...
              className="text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] font-serif text-zen-stone leading-[0.9] italic select-none"
            >
              <motion.span 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
        ...
        >
            ...
            <motion.div 
              ...
              className="absolute inset-0 border border-zen-gold/20 translate-x-4 translate-y-4 md:translate-x-10 md:translate-y-10 -z-10"
            ></motion.div>
            <motion.div 
              animate={{ rotate: [0, -1, 1, 0] }}
              transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
              className="absolute inset-0 border border-zen-stone/5 translate-x-8 translate-y-8 md:translate-x-20 md:translate-y-20 -z-20"
            ></motion.div>
            
            {/* Conteneur Diaporama */}
            <motion.div 
              whileHover={{ rotate: 1, x: window.innerWidth > 1024 ? 80 : 0 }}
              className="relative overflow-hidden bg-white p-3 md:p-5 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] aspect-[3/4] transition-all duration-1000"
            >
