      ...
      >
        ...
        <div className="p-6 border-b border-zen-beige flex justify-between items-center bg-white">
          <div className="flex items-center space-x-3">
             ...
             <h2 className="text-xl font-serif italic text-zen-stone">{t('admin.dashboard', { defaultValue: 'Tableau de Bord - Frida Kahlo Mode' })}</h2>
          </div>
          <div className="flex items-center space-x-4">
             {SUPABASE_CONFIGURED ? (
               <div className="flex items-center space-x-2 text-[8px] uppercase tracking-widest text-green-600 bg-green-50 px-3 py-1 rounded-full border border-green-100">
                 ...
                 <Icons.Database />
                 <span>{t('admin.supabase.connected', { defaultValue: 'Supabase Connecté' })}</span>
               </div>
             ) : (
               <div className="flex items-center space-x-2 text-[8px] uppercase tracking-widest text-amber-600 bg-amber-50 px-3 py-1 rounded-full border border-amber-100">
                 <Icons.Database />
                 <span>{t('admin.supabase.notConfigured', { defaultValue: 'Supabase non configuré' })}</span>
               </div>
             )}
             <button 
                onClick={handleSave}
             ...
             >
                ...
                <span>{isSaving ? t('admin.saving', { defaultValue: "Enregistrement..." }) : t('admin.save', { defaultValue: "Enregistrer" })}</span>
             </button>
             <button 
             ...
             >
                <Icons.Palette />
                <span>{t('admin.sqlHelp', { defaultValue: 'Aide SQL' })}</span>
             </button>
             <button 
             ...
             >
                <Icons.Database />
                <span>{t('admin.testConnection', { defaultValue: 'Tester Connexion' })}</span>
             </button>
             <button 
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-20 md:w-64 border-r border-zen-beige bg-zen-beige/10 p-4 space-y-2">
            {[
              { id: 'titles', icon: Icons.Type, label: t('admin.tabs.titles', { defaultValue: 'Textes & Titres' }) },
              { id: 'artworks', icon: Icons.Image, label: t('admin.tabs.gallery', { defaultValue: 'Galerie' }) },
              { id: 'bio', icon: Icons.Type, label: t('admin.tabs.bio', { defaultValue: 'Biographie' }) },
              { id: 'contact', icon: Icons.Save, label: t('admin.tabs.contact', { defaultValue: 'Contact' }) },
              { id: 'ui', icon: Icons.Type, label: t('admin.tabs.ui', { defaultValue: 'Interface' }) },
              { id: 'theme', icon: Icons.Palette, label: t('admin.tabs.theme', { defaultValue: 'Design' }) },
            ].map(tab => (
              <button
                key={tab.id}
                ...
                <motion.div key="titles" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className="text-[10px] uppercase tracking-widest text-zen-taupe font-bold">{t('admin.fields.firstName', { defaultValue: 'Prénom (Hero)' })}</label>
                          <input 
                            type="text" 
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] uppercase tracking-widest text-zen-taupe font-bold">{t('admin.fields.lastName', { defaultValue: 'Nom (Hero)' })}</label>
                          <input 
                            type="text" 
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] uppercase tracking-widest text-zen-taupe font-bold">{t('admin.fields.heroSubtitle', { defaultValue: 'Sous-titre Hero' })}</label>
                          <input 
                            type="text" 
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] uppercase tracking-widest text-zen-taupe font-bold">{t('admin.fields.heroLocation', { defaultValue: 'Localisation Hero' })}</label>
                          <input 
                            type="text" 
                        ...
                        <div className="space-y-2 col-span-2">
                          <label className="text-[10px] uppercase tracking-widest text-zen-taupe font-bold">{t('admin.fields.heroQuote', { defaultValue: 'Citation Hero' })}</label>
                          <textarea 
                            rows={2}
                      ...
                      <div className="pt-8 border-t border-zen-beige">
                        <div className="flex justify-between items-center mb-6">
                           <div>
                              <h4 className="text-[11px] uppercase tracking-widest text-zen-stone font-bold">{t('admin.heroSlideshow', { defaultValue: 'Diaporama Hero' })}</h4>
                              <p className="text-[9px] text-zen-taupe mt-1">{t('admin.heroSlideshowDesc', { defaultValue: "Gérez les images qui défilent en page d'accueil" })}</p>
                           </div>
                          <button 
                          ...
                          >
                            <Icons.Plus />
                            <span>{t('admin.addHeroImage', { defaultValue: 'Ajouter une image' })}</span>
                          </button>
                        </div>
              ...
              {activeTab === 'artworks' && (
                <motion.div key="artworks" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                    <h3 className="text-sm uppercase tracking-widest font-bold">{t('admin.manageArtworks', { defaultValue: 'Gestion des Œuvres' })}</h3>
                    <div className="flex flex-wrap gap-2">
                      ...
                      >
                        <Icons.Upload />
                        <span>{t('admin.importImage', { defaultValue: 'Importer une image' })}</span>
                      </button>
                      <button 
                      ...
                      >
                        <Icons.Plus />
                        <span>{t('admin.createManually', { defaultValue: 'Créer manuellement' })}</span>
                      </button>
                    </div>
                  </div>
                  {isUploading === 'new' && (
